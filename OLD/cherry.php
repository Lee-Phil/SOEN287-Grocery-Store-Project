...
<body>
  ...
  <div class="row">
  <div class = "col-lg-6">
  <img src = "Images/cherry.jpg" alt = "cherry" style= "height:250px;width:300px;" class="img-fluid">
  </div>

  <div class = "col-lg-6">
    Cherries <br>
    <strong>$</strong><strong id="value">0.20</strong><strong> avg. each</strong> <br>
      ...
      <label for="Quantity">Quantity:</label> 
        ...
        <div class="collapse" id="bagel">
          <div class="card card-body">
           Fresh cherries from South America!
          </div>
          </div>
    ...
    <!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Cherries"; //Add this to every page
                $_POST['cost'] = "0.20"; //Add this to every page
