...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/strawberry.jpg" alt = "strawberry" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class = "col-lg-6">
      Strawberries <br>
      <strong>$</strong><strong id="value">0.15</strong><strong> avg. each</strong> <br>
