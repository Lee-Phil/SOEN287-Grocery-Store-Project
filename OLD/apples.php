...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class = "col-lg-6">
        <img src = "Images/apple.jpg" alt = "apple" style= "height:250px;width:300px;" class="img-fluid">
    </div>
    ...
    <div class="col-lg-6">
        ...
        <strong>$</strong><strong id="value">0.50</strong><strong> avg. each</strong> <br>
        ...
        <div class="collapse" id="apple">
          <div class="card card-body">
            Delicious red apples picked from local apple trees in Quebec. An apple a day keeps the doctors away!
          </div>
        </div>
      </div>
...
<!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Apples"; //Add this to every page
                $_POST['cost'] = "0.50"; //Add this to every page
