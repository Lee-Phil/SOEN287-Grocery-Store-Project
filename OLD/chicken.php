...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/chicken.jpg" alt = "Chicken" style= "height:250px;width:300px;" class="img-fluid">
    </div>
    ...
    <div class="col-lg-6">
        ...
        <strong>$</strong><strong id="value">5.99</strong><strong> / lb</strong>  </p>
        ...
        <div class="collapse" id="bagel">
          <div class="card card-body">
           Fresh chicken raised with care!
          </div>
          </div>
      ...
      <?php
                ...
                $_POST['itemName'] = "Chicken"; //Add this to every page
                $_POST['cost'] = "5.99"; //Add this to every page
