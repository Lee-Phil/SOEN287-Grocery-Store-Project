...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/cucumber.jpg" alt = "cucumber" style= "height:250px;width:300px;" class="img-fluid">
    </div>
 ...
 Fresh green cucumbers for any salad!          
 </div>
        </div>
      </div>
...
<!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Cucumbers"; //Add this to every page
