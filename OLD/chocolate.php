...
<div id="page-container">
  <div class="container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/chocolate.jpg" alt = "chocolate" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Chocolate <br>
         <form action = "" name="myForm" method = "post"> <!-- put this in every product page -->
        <strong>$</strong><strong id="value">2.99</strong><strong> avg. each</strong> <br>
        ...
        Made with fresh milk from the British Isles and fair trade cocoa beans.
  </div>
        </div>
      </div>
            </form>
      ...
      <?php
                ...
                $_POST['itemName'] = "Chocolate"; //Add this to every page
