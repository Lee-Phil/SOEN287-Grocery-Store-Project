...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/banana.jpeg" alt = "banana" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Banana <br>
        <strong>$</strong><strong id="value">0.33</strong><strong> avg. each</strong> <br>
        <form action = "" name="myForm" method = "post">
            <label for="Quantity">Quantity:</label> 
            <input type="number" name ="quantity" id="Quantity" value="0" min="0" >
            
           <div>
              Subtotal ($): <input type="text" size="10" id="subtotal" value= "0" name= "subtotal" readonly />
            </div>
             <br><input type = "submit"  value = "Add to Cart" class= "button" onclick="addToCart()" name = "submit"/>
          ...
          <div class="collapse" id="banana">
            <div class="card card-body">
              Ripe bananas grown and harvested in Sunny side California. Great source of Potassium and vitamins!
            </div>
          </div>
        </div>
     </div>
     ...
     <!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Bananas"; //Add this to every page
                $_POST['cost'] = "0.33"; //Add this to every page
