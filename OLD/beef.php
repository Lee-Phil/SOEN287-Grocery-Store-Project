...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <h5> <a class="btn btn-outline-dark" href = "meats.php"> &lt;  Back to Meats and Poultry</a> </br></h5>

    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/beef.jpg" alt = "beef" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class = "col-lg-6">
        Beef <br>
         <form action = "" name="myForm" method = "post"> <!-- put this in every product page -->
        <strong>$</strong><strong id="value">2.99</strong>/lb<strong> avg. each</strong> <br>
        ...
        <div class="collapse" id="apple">
          <div class="card card-body">
            Delicious beef raised in Canada!
          </div>
        </div>
      </div>
      ...
      <div>
            <br>
                ...
                $_POST['itemName'] = "Beef"; //Add this to every page
                $_POST['cost'] = "2.99"; //Add this to every page
