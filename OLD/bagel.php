...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/bagel.jpg" alt = "bagel" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class = "col-lg-6">
    <div>
        Bagel <br>
        <strong>$</strong><strong id="value">2.99</strong><strong> per bag (6 slices)</strong> <br>
        <form action = "" name="myForm" method = "post"> <!-- put this in every product page -->
            ...
            <div>
              Subtotal ($): <input type="text" size="10" id="subtotal" name= "subtotal" value= "0"readonly />
            </div>
      ...
      <?php
                ...
                $_POST['itemName'] = "Bagels"; //Add this to every page
