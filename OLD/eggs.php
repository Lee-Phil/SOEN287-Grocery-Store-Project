...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/eggs.jpg" alt = "eggs" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Eggs <br>
  <form action = "" name="myForm" method = "post"> <!-- put this in every product page -->
        <strong>$</strong><strong id="value">2.99</strong><strong> per dozen</strong> <br>
...
<!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Eggs"; //Add this to every page
