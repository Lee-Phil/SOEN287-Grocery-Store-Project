...
<body>
  ...
  <div id="description" class="row">
    <div class="col-lg-6">
      ...
      <img src="Images/cauliflower.jpg" alt="Cauliflower" class="img-fluid">
    </div>
    <div class="col-lg-6 ">
      <div class="row">
        <div class="col">
          <h2 style="padding: 0 0 20px">Cauliflower</h2>
        </div>
        <div class="col">
          <button type="button" class="btn btn-dark descr-btn" onclick="moreDescriptionCauliflower()">More description</button>

        </div>
        <p id="more-description-cauliflower"></p>
      </div>      
      <form action="" name="myForm" method="POST">
        <select class="form-select" id="size"  onclick="displayTotal()" name="cost">
          <option selected id="option0" value="0">Please select a weight </option>
          <option id="option1" value="1.77">Cauliflower (0.5 kg)</option>
          <option id="option2" value="4.55">Cauliflower (1 kg)</option>
          <option id="option3" value="9.62">Cauliflower (2 kg)</option>
        </select>
        ...
        <div class="row">
          ...
          <input type="submit" class="btn btn-dark btns" name="submit" value="Add To Cart">

              <?php
                
                // $_POST['itemName'] = "Cauliflower";
