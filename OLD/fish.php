...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/fish.jpg" alt = "Fish" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Fish <br>
        <strong>$4.99 / lb </strong> <br>
        <form action="" name="fish" onclick="calculateFishSubtotal()">
        ...
        <div class="collapse" id="bagel">
          <div class="card card-body">
           Fresh fish from the Atlantic ocean!
          </div>
          </div>
