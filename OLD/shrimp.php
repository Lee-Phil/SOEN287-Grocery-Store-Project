...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/shrimp.jpg" alt = "Shrimp" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Shrimp <br>
        <strong>$4.99 / lb </strong> <br>
        <form action="" name="shrimp" onclick="calculateShrimpSubtotal()">
            <label for="Quantity">Weight (lbs):</label> 
        ...
        <div class="collapse" id="bagel">
          <div class="card card-body">
           Fresh shrimp from the Atlantic ocean!
          </div>
          </div>
