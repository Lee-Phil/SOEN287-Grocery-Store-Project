...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/bread.jpg" alt = "bread" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class="col-lg-6">
        Bread <br>
        <form action = "" name="myForm" method = "post"> <!-- put this in every product page -->
        <strong>$</strong><strong id="value">2.99</strong><strong> per bag (12 slices)</strong> <br>
...
<!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Bread"; //Add this to every page
