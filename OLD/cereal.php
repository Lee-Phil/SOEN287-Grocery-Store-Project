...
<div id="page-container">
  <div class = "container" id="content-wrap">
    ...
    <div class = "col-lg-6">
        <img src = "Images/cereal.jpg" alt = "cereal" style= "height:250px;width:300px;" class="img-fluid">
    </div>

    <div class = "col-lg-6">
        Cereal <br>
        <strong>$</strong><strong id="value">3.99</strong><strong> per box (300 g)</strong> <br>
      ...
      <label for="Quantity">Quantity:</label> 
        ...
        <div class="collapse" id="bagel">
          <div class="card card-body">
           Fresh cereal for a perfect breakfast!
          </div>
          </div>
...
<!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Cereal"; //Add this to every page
                $_POST['cost'] = "3.99"; //Add this to every page
