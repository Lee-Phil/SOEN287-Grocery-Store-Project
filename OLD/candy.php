...
<div id="page-container">
  <div class="container" id="content-wrap">
    ...
    <div class="row">
    <div class = "col-lg-6">
        <img src = "Images/candy.jpg" alt = "candy" style= "height:250px;width:300px;" class="img-fluid">
    </div>
   ...
   <div class="col-lg-6">
        ...
        <strong>$</strong><strong id="value">0.05</strong><strong> avg. each</strong> <br>
        ...
        <div class="collapse" id="apple">
          <div class="card card-body">
           Every pack of Skittles gives you the chance to Taste the Rainbow, creating a taste sensation that makes even the most stoic of unicorns smile.
          </div>
        </div>
      </div>
    </form>
    ...
    <!-- put this in every product page -->
      <?php
                ...
                $_POST['itemName'] = "Candy"; //Add this to every page
                $_POST['cost'] = "0.05"; //Add this to every page
